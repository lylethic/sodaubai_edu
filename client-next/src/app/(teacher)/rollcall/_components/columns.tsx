...
interface RollCallColumnProps {
	handleRedirectToDetail: (data: RollCallType) => void;
	handleEdit: (data: RollCallType) => void;
	handleDelete: (data: RollCallType) => void;
	pageNumber: number;
	pageSize: number;
}

export const getRollCallsColumns = ({
	handleRedirectToDetail,
	handleEdit,
	handleDelete,
	pageNumber,
	pageSize,
}: RollCallColumnProps): ColumnDef<RollCallType>[] => [
	{
		id: 'select',
		header: ({ table }) => (
