...
export default function BulkDeleteSubjectDialog(props: Props) {
	...
	const handleBulkDelete = async () => {
		try {
			...
			const response = await subjectApiRequest.bulkdelete(props.selectedItems);
	...
	return (
		<AlertDialog>
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					<AlertDialogTitle>Bạn có muốn xóa các môn học này?</AlertDialogTitle>
					<AlertDialogDescription>
						Các môn học đã chọn sẽ bị xóa vĩnh viễn.
					</AlertDialogDescription>
				</AlertDialogHeader>
				<AlertDialogFooter>
