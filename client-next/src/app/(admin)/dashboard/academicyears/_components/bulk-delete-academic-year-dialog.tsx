...
export default function BulkDeleteAcademicYearDialog(props: Props) {
	...
	const handleBulkDelete = async () => {
		try {
			...
			const response = await namHocApiRequest.bulkdelete(props.selectedItems);
	...
	return (
		<AlertDialog>
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					<AlertDialogTitle>Bạn có muốn xóa các năm học này?</AlertDialogTitle>
					<AlertDialogDescription>
						Các năm học đã chọn sẽ bị xóa vĩnh viễn.
					</AlertDialogDescription>
				</AlertDialogHeader>
				<AlertDialogFooter>
